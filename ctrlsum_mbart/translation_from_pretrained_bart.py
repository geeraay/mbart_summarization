...
class TranslationFromPretrainedBARTTask(TranslationTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--lang-id', required=True, metavar='LANGID',help='lang id for monolingual summarization purpose')
        # fmt: on
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = load_langpair_dataset(
            ...
            append_source_id=True, lang_id=lang_id, truncate_source=self.args.truncate_source
            )
    ...
    def build_generator(self, models, args):
        if getattr(args, 'score_reference', False):
            ...
            return SequenceScorer(
                ...
                eos=self.tgt_dict.index('[{}]'.format(self.args.lang_id))
            )
        else:
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths):
        src_lang_id = self.source_dictionary.index('[{}]'.format(self.args.lang_id))
